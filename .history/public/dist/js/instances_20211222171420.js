...
$(document).ready(() => {
    ...
    if ($(".ba-datatable-row-separated-details").length) {
        let baDatatable = $(".ba-datatable-row-separated-details").DataTable({
            "paging": false,
            "lengthChange": false,
            "searching": false,
            "ordering": true,
        ...
        $('.ba-datatable-row-separated-details tbody').on('click', 'td.dt-control', function () {
          var template  = $('.invoice-form-template').html();
          var tr = $(this).closest('tr');
          var row = baDatatable.row( tr );
